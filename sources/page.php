...
<body>
    	<?php
			...
			if(isset($_POST['Submit'])){
				...
				//create a new bucket
				$s3->putBucket("www.navtest.com", S3::ACL_PUBLIC_READ);
				
				//move the file
				if ($s3->putObjectFile($fileTempName, "www.navtest.com", $fileName, S3::ACL_PUBLIC_READ_WRITE)) {
...
<?php
	...
	$contents = $s3->getBucket("www.navtest.com");
