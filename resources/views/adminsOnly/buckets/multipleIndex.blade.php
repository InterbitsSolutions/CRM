...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form class="form-material form-horizontal m-t-30" action="{{ url('/multiple-buckets') }}" method="post">
            ...
            <ul class="nav navbar-top-links navbar-right padding-10">
                ...
                <button type="submit" class="btn btn-info waves-effect waves-light m-r-10" onclick="$('#overlay').show();">Submit</button>
            </ul>
        </form>
                    ...
                    <div class="table-responsive col-sm-12">
                        <table id="example23" class="table table-striped table_grid">
                            ...
                            @foreach($contents['Buckets'] as $content)
                                ...
                                try
                                {
//                                    $locati+on = $s3client->getBucketLocation(array(
//                                            'Bucket' => $content['Name']
//                                    ));
