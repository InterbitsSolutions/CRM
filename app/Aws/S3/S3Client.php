...
use App\Aws\Api\ApiProvider;
use App\Aws\Api\DocModel;
use App\Aws\Api\Service;
use App\Aws\AwsClient;
use App\Aws\ClientResolver;
use App\Aws\Command;
use App\Aws\Exception\AwsException;
use App\Aws\HandlerList;
use App\Aws\Middleware;
use App\Aws\RetryMiddleware;
use App\Aws\ResultInterface;
use App\Aws\CommandInterface;
use App\GuzzleHttp\Exception\RequestException;
use App\GuzzleHttp\Promise;
use App\GuzzleHttp\Psr7;
use App\Psr\Http\Message\RequestInterface;
